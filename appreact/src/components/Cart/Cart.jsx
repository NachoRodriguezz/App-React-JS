...
const Cart = () => {
    ...
    return (
        <>
            ...
            {cart.length === 0 ? 
            <div>
                <p style={{color : "white"}}>Tu carrito esta vacio</p>
                ...
                <div className="row g-0">
                    ...
                    <div className="col-md-8">
                        <div className="card-body">
                            ...
                            <button className="btn btn-dark" onClick={() => removeItem(prod.id)}>Eliminar del carrito</button>
                        </div>
            ...
            <div>
                ...
                <button className="btn btn-light buttonCarts" onClick={emptyCart}>Limpiar Carrito</button>
                <Link to="/checkout">
